...
*
*i.e. range of integer - to +, color , mobile company --> create your own range
*  ; --> semicolon not compulsory enum
*  
*  --->define enum separate  and inside class and outside of class
*
*enum use in switch
*
*in c & c++ enum not allow variable and method but java supported variable and method in enum
*
*every java class Enum extends Enum --> enum extend object class
*
*
...
//internally create class of enum and variable static final as below same u use enum
